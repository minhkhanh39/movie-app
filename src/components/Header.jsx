    ...
    <div className="p-4 bg-black flex items-center justify-between ">
      <div className="flex items-center space-x-4">
        ...
        <nav className="flex items-center space-x-4">
          <a href="#" className="text-white hover:font-bold hover:text-red-500">
            Home
          </a>
          <a href="#" className="text-white hover:font-bold hover:text-red-500">
            TV Show
      ...
      <div className="flex items-center space-x-4">
        <div className="relative flex items-center bg-[rgba(184,178,178,0.1)] rounded-sm py-1 px-1">
          <input
            ...
            className=" text-white  rounded-sm py-1 ml-3 outline-none"
            onChange={(e) => setSearch(e.target.value)}
            value={textSearch}
          />
          <FontAwesomeIcon
            icon={faMagnifyingGlass}
            className="text-white mr-3  cursor-pointer hover:text-gray-400"
